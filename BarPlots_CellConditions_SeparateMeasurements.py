...
names=['Ctrl', 'Colch', 'Cytod10', 'Cytod25', 'Jaspla']
...
names_meas=[data_0, data_1, data_2, data_3, data_4]
files=['data_Elasto\Control_BilayerFit.tsv', 'data_Elasto\Colch_1000uM_BilayerFit.tsv', 'data_Elasto\CytoD_10uM_BilayerFit.tsv', 'data_Elasto\CytoD_25uM_BilayerFit.tsv', 'data_Elasto\Jaspla_1uM_BilayerFit.tsv']
filesY=['data_Elasto\Control_Y.np.txt', 'data_Elasto\Colch_1000uM_Y.np.txt', 'data_Elasto\CytoD_10uM_Y.np.txt', 'data_Elasto\CytoD_25uM_Y.np.txt', 'data_Elasto\Jaspla_1uM_Y.np.txt']
file_out=r"C:\Users\Ines\Documents\PhD\Projects\Cortex-Massimo\AnalysisScriptMassimo\GitHub_Nanoindentation2\nanoindentation\data_figures\Fig5bcd_CellConditions_SeparateMeasurements_BarPlots.csv"
...
for i in range(len(files_meas)):
    ...
    # E0m_means=np.mean(E0_meas)
    # E0m_std=np.std(E0_meas)
    # Ebm_means=np.mean(Eb_meas)
    # Ebm_std=np.std(Eb_meas)
    # d0m_means=np.mean(d0_meas)
    # d0m_std=np.std(d0_meas)
    # Ym_means=np.mean(Y_meas_means)
...
scatterx=[-0.4, -0.2, -0.1, 0.2, 0.4, 0.6, 0.8, 1.4, 1.6, 1.8, 2.2, 2.4, 2.8, 3.2, 3.4, 3.8, 4.2, 4.4]
...
nice_names=['Control', 'Colchicine', 'Cytochalasin D 10', 'Cytochalasin D 25', 'Jasplakinolide']
