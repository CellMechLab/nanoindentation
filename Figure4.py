...
fnames=['data_figures/Fig4b_IndentCellExample.csv', 'data_figures/Fig4c_ElastoCellExample_AllData.csv', 'data_figures/Fig4c_ElastoCellExample_MedCurve+Fit.csv', 'data_figures/Fig4d_HistoCellExample.csv']
