...
names=['Control', 'Colch', 'Cytod10', 'Cytod25', 'Jaspla']
...
other_names=['Control', 'Colch_1000uM', 'CytoD_10uM', 'CytoD_25uM', 'Jaspla_1uM']
files=[]
filesY=[]
fileY=[]
for n in other_names:
    files.append('data_Elasto\\' +n +'_BilayerFit.tsv')
    filesY.append('data_Elasto\\' + n + '_Y.np.txt')
    fileY.append('data_figures\Fig5a_AvHertzCells_' +n +'.csv')

file_out=r"C:\Users\Ines\Documents\PhD\Projects\Cortex-Massimo\AnalysisScriptMassimo\GitHub_Nanoindentation2\nanoindentation\data_figures\Fig5bcd_CellConditions_AvHertz_SeparateMeasurements_BarPlots.csv"
