...
file_bar='data_figures/Fig5bcd_CellConditions_AvHertz_SeparateMeasurements_BarPlots.csv'
file_bar_single='data_figures/Fig5bcd_CellConditions_AvHertz_SeparateMeasurements_BarPlots_SingleValues.csv'
