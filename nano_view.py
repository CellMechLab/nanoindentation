...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_7.addWidget(self.es_analysis)
        self.verticalLayout_6 = QtWidgets.QVBoxLayout()
        self.verticalLayout_6.setObjectName("verticalLayout_6")
        self.g_es = PlotWidget(self.analysis)
        self.g_es.setObjectName("g_es")
        self.verticalLayout_6.addWidget(self.g_es)
        self.g_decay = PlotWidget(self.analysis)
        self.g_decay.setEnabled(False)
