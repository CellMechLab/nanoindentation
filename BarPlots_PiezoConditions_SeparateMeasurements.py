...
files=['data_Piezo\WT_BilayerFit.tsv', 'data_Piezo\P1_BilayerFit.tsv', 'data_Piezo\KO_BilayerFit.tsv', 'data_Piezo\Plastin_BilayerFit.tsv', 'data_Piezo\Filamin_BilayerFit.tsv', 'data_Piezo\P1+10uMYoda_BilayerFit.tsv', 'data_Piezo\KO+10uMYoda_BilayerFit.tsv']
filesY=['data_Piezo\WT_Y.np.txt', 'data_Piezo\P1_Y.np.txt', 'data_Piezo\KO_Y.np.txt', 'data_Piezo\Plastin_Y.np.txt', 'data_Piezo\Filamin_Y.np.txt', 'data_Piezo\P1+10uMYoda_Y.np.txt', 'data_Piezo\KO+10uMYoda_Y.np.txt']
file_out=r"C:\Users\Ines\Documents\PhD\Projects\Cortex-Massimo\AnalysisScriptMassimo\GitHub_Nanoindentation2\nanoindentation\data_Piezo\PiezoConditions_SeparateMeasurements_BarPlots.csv"
