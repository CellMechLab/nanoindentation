...
class NanoWindow(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        self.curve_fit.setPen(pg.mkPen(pg.QtGui.QColor(0, 0, 255, 150), width=2, style=QtCore.Qt.DashLine ))
        ...
        self.histo_esdata = pg.PlotCurveItem([0, 0], [0], clickable=False, stepMode=True, fillLevel=0,brush=pg.mkBrush([255, 0, 0, 50]))
        ...
        self.histo_fit.setPen(pg.mkPen(pg.QtGui.QColor(0, 0, 255, 150), width=2, style=QtCore.Qt.DashLine))
        self.ui.g_histo.plotItem.addItem(self.histo_fit)
        self.histo_esfit = pg.PlotCurveItem(clickable=False)
        self.histo_esfit.setPen(pg.mkPen(pg.QtGui.QColor(255, 0, 0, 150), width=2, style=QtCore.Qt.DashLine))
        self.ui.g_histo.plotItem.addItem(self.histo_esfit)
        self.es_top = pg.PlotCurveItem(clickable=False)
        self.es_top.setPen(pg.mkPen(pg.QtGui.QColor(255, 0, 0, 150), width=1, style=QtCore.Qt.SolidLine))
        self.ui.g_decay.plotItem.addItem(self.es_top)
        self.es_bottom = pg.PlotCurveItem(clickable=False)
        self.es_bottom.setPen(pg.mkPen(pg.QtGui.QColor(255, 0, 0, 150), width=1, style=QtCore.Qt.SolidLine))
        self.ui.g_decay.plotItem.addItem(self.es_bottom)
        self.es_averageZoom = pg.PlotCurveItem(clickable=False)
        self.es_averageZoom.setPen(pg.mkPen(pg.QtGui.QColor(255, 0, 0, 150), width=3, style=QtCore.Qt.SolidLine))
        self.ui.g_decay.plotItem.addItem(self.es_averageZoom)
        self.es_averageFit = pg.PlotCurveItem(clickable=False)
        self.es_averageFit.setPen(pg.mkPen(pg.QtGui.QColor(0, 0, 0, 250), width=1, style=QtCore.Qt.DashLine))
    ...
    def open_folder(self):
        ...
        self.fdistance_fit.setPen(pg.mkPen(pg.QtGui.QColor(0, 0, 255, 150), width=2, style=QtCore.Qt.DashLine))
        self.ui.g_fdistance.plotItem.addItem(self.fdistance_fit)
        self.indentation_fit = pg.PlotCurveItem(clickable=False)
        self.indentation_fit.setPen(pg.mkPen(pg.QtGui.QColor(0, 0, 255, 150), width=2, style=QtCore.Qt.DashLine))
        self.ui.g_indentation.plotItem.addItem(self.indentation_fit)
        self.es_average = pg.PlotCurveItem(clickable=False)
        self.es_average.setPen(pg.mkPen(pg.QtGui.QColor(255, 0, 0, 150), width=2, style=QtCore.Qt.SolidLine))
