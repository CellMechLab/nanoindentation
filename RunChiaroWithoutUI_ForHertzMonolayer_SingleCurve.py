...
fname_AvHertzData =r"C:\Users\Ines\Documents\PhD\Projects\Cortex-Massimo\AnalysisScriptMassimo\GitHub_Nanoindentation2\nanoindentation\data_figures\Fig1b_IndentHertz100Noise_MedCurve+Fit.csv"


GenerateFake_params = [0, 4000,  5000, 2000, 300, 2, 1] #noiselevel, maxlength, E1, E2, d0, mode: 0=50*same Ros curve, 1= Ros curves for different d, 2= 50*Hertz curve
Yfit_params = [0, 1000, 'noerror']  # mode (0: maxIndentation, 1: maxForce), maxIndentValue
...
CsvSettings=[True, True, True, True, False, True, 'single', 'noerror'] #0: save force curves, 1: save all elasto data, 2: save elasto med + fit, 3: save histo data + gauss, 4: 'single' or 'bilayer', error_in_med_curve yes/no
