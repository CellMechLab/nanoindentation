...
fnames=['data_figures/Fig2b_IndentGel.csv', 'data_figures/Fig2c_ElastoGel_AllData.csv', 'data_figures/Fig2c_ElastoGel_MedCurve+Fit.csv', 'data_figures/Fig2d_HistoGel.csv']
...
p.ForceCurves(pos=1, ax_lim=[500])
